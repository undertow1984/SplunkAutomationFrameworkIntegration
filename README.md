<h1>Splunk Automation Framework Integration License Agreement</h1>

This (Splunk Automation Framework Integration License Agreement also known as Splunk Connector Library) project contains components licensed under the Apache 2.0 license agreement therefore this project is also licensed under the same read the LICENSE file or read here for the most up to date agreement: https://www.apache.org/licenses/LICENSE-2.0
